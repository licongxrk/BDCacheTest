...
typedef void (^BDMemoryCacheBlock)(BDMemoryCache *cache);
typedef void (^BDMemoryCacheObjectBlock)(BDMemoryCache *cache, NSString *key, id object);
...
@property (copy) BDMemoryCacheObjectBlock willAddObjectBlock;

@property (copy) BDMemoryCacheObjectBlock willRemoveObjectBlock;

@property (copy) BDMemoryCacheBlock willRemoveAllObjectsBlock;

@property (copy) BDMemoryCacheObjectBlock didAddObjectBlock;

@property (copy) BDMemoryCacheObjectBlock didRemoveObjectBlock;

@property (copy) BDMemoryCacheBlock didRemoveAllObjectsBlock;

@property (copy) BDMemoryCacheBlock didReceiveMemoryWarningBlock;

@property (copy) BDMemoryCacheBlock didEnterBackgroundBlock;
 ...
 */
- (void)handleMemoryWarning __deprecated_msg("This happens automatically in BDCache. There's no longer a need to call it directly.");

/**
 Handle the application having been backgrounded.
 */
- (void)handlerApplicationBackground __deprecated_msg("This happens automatically in BDCache. There’s no longer a need to call it directly.");
